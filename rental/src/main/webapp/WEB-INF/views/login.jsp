...
<form action="/login" method="POST">
	...
	<input type="text" class="form-signin form-control-lg" placeholder="아이디 (admin)" name="id"/>
	...
	<input type="password" class="form-signin form-control-lg" placeholder="비밀번호 (1234)" name="password"/>
